...
const galleryItems = [
  { src: '/logo.jpg', captionEn: 'Community Education Workshop', captionEs: 'Taller de Educación Comunitaria', category: 'Workshop' },
  { src: '/logo.jpg', captionEn: 'Mental Health Forum 2024', captionEs: 'Foro de Salud Mental 2024', category: 'Forum' },
  { src: '/logo.jpg', captionEn: 'Youth Prevention Event', captionEs: 'Evento de Prevención Juvenil', category: 'Event' },
  { src: '/logo.jpg', captionEn: 'Legislative Advocacy Day', captionEs: 'Día de Abogacía Legislativa', category: 'Advocacy' },
  { src: '/logo.jpg', captionEn: 'Community Outreach Program', captionEs: 'Programa de Alcance Comunitario', category: 'Outreach' },
  { src: '/logo.jpg', captionEn: 'Healing & Support Circle', captionEs: 'Círculo de Sanación y Apoyo', category: 'Support' },
  { src: '/logo.jpg', captionEn: 'School Prevention Workshop', captionEs: 'Taller de Prevención Escolar', category: 'Workshop' },
  { src: '/logo.jpg', captionEn: 'Safe Disposal Drive', captionEs: 'Campaña de Eliminación Segura', category: 'Outreach' },
  { src: '/logo.jpg', captionEn: 'Town Hall Meeting', captionEs: 'Reunión Comunitaria', category: 'Event' },
];
